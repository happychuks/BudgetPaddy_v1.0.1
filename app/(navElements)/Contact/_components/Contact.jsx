...
const Contact = () => {
  return (
    <div className="max-w-md mx-auto p-4 pt-6 md:p-8 md:pt-12">
      ...
      <p className="text-xl mb-6">Have a question or need support? Send an email to us <a href="mailto:happychukwuma@gmail.com" className="font-bold" style={{ textDecoration: 'underline solid #000' }}>Here</a>.</p>
